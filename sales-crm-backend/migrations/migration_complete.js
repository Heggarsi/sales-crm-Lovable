...
CREATE TABLE contacts (
  ...
  CONSTRAINT fk_contacts_account FOREIGN KEY (AccountId) REFERENCES account (AccountId) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE deals (
  ...
  CONSTRAINT fk_deals_account FOREIGN KEY (AccountId) REFERENCES account (AccountId) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE leads (
  ...
  CONSTRAINT fk_leads_converted_account FOREIGN KEY (ConvertedAccountId) REFERENCES account (AccountId) ON DELETE SET NULL ON UPDATE CASCADE,
...
CREATE TABLE appointment (
  ...
  CONSTRAINT fk_appointment_account FOREIGN KEY (AccountId) REFERENCES account (AccountId) ON DELETE SET NULL ON UPDATE CASCADE,
